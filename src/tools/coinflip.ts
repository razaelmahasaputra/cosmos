...
const coinflipTool: ToolModule = {
    ...
    execute: async (args: Record<string, any>, ctx: ToolContext) => {
        ...
        let guess = '';
        if (inputStr.includes('kepala') || inputStr.includes('heads') || inputStr.includes('head') || inputStr.includes('h')) {
            guess = 'heads';
        } else if (inputStr.includes('ekor') || inputStr.includes('tails') || inputStr.includes('tail') || inputStr.includes('t')) {
            guess = 'tails';
        }
